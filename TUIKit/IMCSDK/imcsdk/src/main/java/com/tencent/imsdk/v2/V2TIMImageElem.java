...
public class V2TIMImageElem extends V2TIMElem {
    ...
    public class V2TIMImage implements Serializable {
        ...
        public void downloadImage(final String path, final V2TIMDownloadCallback v2TIMDownloadCallback) {
            nativeDownloadImage(uuid,url, type, path, new IMCallback(v2TIMDownloadCallback) {
                @Override
        ...
        //底层方法
        native void nativeDownloadImage(String uuid,String url, int imageType, String path, IMCallback callback);
    }
