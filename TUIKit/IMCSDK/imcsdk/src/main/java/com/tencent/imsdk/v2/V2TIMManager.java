...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public native void nativeAddSDKListener(V2TIMSDKListener listener, String listenerPath);

    public native void nativeRemoveSDKListener(String listenerPath);

    public native boolean nativeInitSDK(int sdkAppID, V2TIMSDKConfig sdkConfig);

    public native void nativeUninitSDK();

    public native void nativeLogin(String userID, String userSig, IMCallback callback);

    public native String nativeGetVersion();

    public native long nativeGetServerTime();

    public native void nativeLogout(IMCallback callback);

    public native String nativeGetLoginUser();

    public native int nativeGetLoginStatus();

    public native void nativeAddSimpleMsgListener(V2TIMSimpleMsgListener v2TIMSimpleMsgListener, String listenerPath);

    public native void nativeRemoveSimpleMsgListener(String listenerPath);
    ...
    public native void nativeAddGroupListener(V2TIMGroupListener listener, String listenerPath);

    public native void nativeRemoveGroupListener(String listenerPath);

    public native void nativeCreateGroup(String groupType, String groupID, String groupName, IMCallback<String> callback);

    public native void nativeJoinGroup(String groupID, String message, IMCallback callback);

    public native void nativeQuitGroup(String groupID, final IMCallback callback);

    public native void nativeDismissGroup(String groupID, final IMCallback callback);

    public native void nativeGetUsersInfo(List<String> userIDList, IMCallback<List<V2TIMUserFullInfo>> callback);

    public native void nativeSetSelfInfo(V2TIMUserFullInfo info, IMCallback callback);
    ...
    public native void nativeGetUserStatus(List<String> userIDList, IMCallback<List<V2TIMUserStatus>> callback);

    public native void nativeSetSelfStatus(V2TIMUserStatus status, IMCallback callback);

    public native void nativeSubscribeUserStatus(List<String> userIDList, IMCallback callback);

    public native void nativeUnsubscribeUserStatus(List<String> userIDList, IMCallback callback);

    public native void nativeCallExperimentalAPI(String api, Object param, IMCallback<Object> callback);
}
