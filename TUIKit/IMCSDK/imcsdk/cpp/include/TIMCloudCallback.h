...
#ifndef SRC_PLATFORM_CROSS_PLATFORM_INCLUDE_TIM_CLOUD_CALLBACK_H_
#define SRC_PLATFORM_CROSS_PLATFORM_INCLUDE_TIM_CLOUD_CALLBACK_H_
...
* @param message_extension_array 扩展信息列表
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
* 
* @example 返回的扩展信息列表 json 示例
* [
*    {
...
*     }
*
* json_conv_array 示例。 具体请参考[ConvInfo](TIM), 
* [{
...
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
*
* @example json_identifier_array 示例
* [ "user15" ]
*/
...
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
*
* @example json_friend_profile_update_array 示例, 具体信息请参考 [FriendProfileItem](TIMCloudDef.h)
* [
*    {
...
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
* 
* @example json_friend_add_request_pendency_array 示例，json key 请参考 [FriendAddPendency](TIMCloudDef.h)
* [
*    {
...
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
*
* @example json_identifier_array 的示例
* [ "user15" ]
*
*/
...
/**
* @brief 好友申请已读通知，如果调用 setFriendApplicationRead 设置好友申请列表已读，会收到这个回调（主要用于多端同步）
*
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
*
*/
...
* @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
*
* @example json_friend_black_added_array 示例。 json key 请参考 [FriendProfile](TIMCloudDef.h)
* [{
...
#endif //SRC_PLATFORM_CROSS_PLATFORM_INCLUDE_TIM_CLOUD_CALLBACK_H_
