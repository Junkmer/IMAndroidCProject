...
namespace tim {
    namespace jni {
        ...
        jobject GroupMemberChangeInfoJni::Convert2JObject(const json::Object &groupMemberChangeInfo_json) {
            ...
            env->SetObjectField(changeItemObj, j_field_id_array_[FieldIDUserID],
                                StringJni::Cstring2Jstring(env, groupMemberChangeInfo_json[kTIMGroupTipMemberChangeInfoIdentifier]));
            env->SetLongField(changeItemObj, j_field_id_array_[FieldIDMuteTime], groupMemberChangeInfo_json[kTIMGroupTipMemberChangeInfoShutupTime].ToInt64());
